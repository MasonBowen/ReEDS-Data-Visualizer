# all of these are manipulated from the gdxrrw package, remade to be more convenient and not throw so many errors
...
rgdx.var.eq <- function (gdxName, symName, names = NULL, compress = FALSE, ts = FALSE, 
